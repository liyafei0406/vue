var featurers = {
	...
	featurers2_2: [
		{featurersImg:'img/zx07.jpg',featurersName:'智能睡眠系统',featurersP:'监控呼吸频率、心跳，发现异常及时报警，保障用户身体健康，并在次日提交完整详尽的睡眠报告，有助改善睡眠状况。'},
		{featurersImg:'img/zx06.jpg',featurersName:'智能门窗系统',featurersP:'根据光线强弱联动调整窗帘开度，根据空气质量联动开窗通风，打造健康舒适的生活环境。'},
		{featurersImg:'img/zx05.jpg',featurersName:'智能门锁系统',featurersP:'指纹、感受应式3/卡、防泄漏密码、临时手机验证码、应急式钥匙插孔五种开锁模式。'},
		{featurersImg:'img/zx04.jpg',featurersName:'智能家电控制系统',featurersP:'边刷牙边浏览天气、穿衣建议、新闻快讯，同时播放音乐、打开厨房的面包机、客厅的饮水机。'},	
		{featurersImg:'img/zx03.jpg',featurersName:'智能影音系统',featurersP:'远程控制全部家电设备，实时查看家电当前开关状态，并可设置家电之间的联动。'},
		{featurersImg:'img/zx02.jpg',featurersName:'智能照明系统',featurersP:'除本地触控外，支持远程操控。结合RGB灯带DIY任意场景氛围模式。'},
		
		{featurersImg:'img/zx01.jpg',featurersName:'智能安防系统',featurersP:'安防门禁系统支持门锁、门磁、人体红外感应器、烟雾报警器、摄像头等多种安防设备的组合，满足家庭安全的第一需求。'},
	]
};
var a5 = Vue.extend({
