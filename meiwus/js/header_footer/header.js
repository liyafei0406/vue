...
var navers = [
				...
				{id:'icon5',catalogue: 'smart_home.html',names:'智能家居'},
				{id:'icon6',catalogue: 'mainstream_style.html?numb3=0',names:'主流风格'},
				{id:'icon7',catalogue: 'culture.html?numb4=0',names:'品牌文化'}
			 ];
var ul1 = Vue.extend({
