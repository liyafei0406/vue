...
var cooperationers = {
	...
	cooperationersDao:'诚约合作',
	cooperationersDaoy:'COOPERATE',
	cooperationersLi: {
	...
	cooperationersDiv: [
				...
				p5:"",
				img2:"",
				img3:'img/15027805699046629-1.png',
				img4:'',
				h6:"",
				p6:""
				},
...
var div5_3 = Vue.extend({
	template:'<div class="dao_title"><div class="div_dao">{{cooperationers.cooperationersDao}}<span>{{cooperationers.cooperationersDaoy}}</span></div></div>'
});
