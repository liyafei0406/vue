...
var newsdetailers = {
	...
	newsdetailersLi: {
		...
		P1:'2017年6月8日，创意快装工场发展史上一个具有里程碑意义的日子——集团公司在全球中小企业股权交易中心挂牌。这也是继创意快装工场上海股权托管交易中心挂牌后，又一次重新定制装修装饰行业标杆企业标准。创意快装工场积蓄了多年的力量，在全球中小企业股权交易中心挂牌挂牌，随着挂牌的锣声的敲响，创意快装工场上了一个新的阶段，一个更高的阶段。',
		P2:'5月份公司B轮融成功融资1.6亿，为本次挂牌提供了重要的助推力量。企业的成功挂牌，不仅展示了企业的发展实力，更预示着企业在未来发展之路上，将借助资本的力量取得更大的飞跃。',
		P3:'2017年是创意快装工场繁花似锦的一年，这一年创意快装工场在赶超梦想的路上，不断超越自我，挑战新高；这一年创意快装工场在项目研发的过程中，不断推陈出新，延伸触角；这一年，创意快装工场在发展规划的蓝图上，不断打破陈腐，长远布局。',
		P4:'创意快装工场，在国家科技部、中国技术市场协会、中国发明协会、中国扶贫开发协会、大专院校的支持下，由创意快装工场总部联合“中国创业就业扶助工程”、“渠道（中国）联盟”共同成立的一个专注于文化创意产业、创新工匠、艺术收藏、VR智能的投资、孵化、管理和运营平台，经过十多年发展，己发展成为集技术研发、项目孵化、品牌管理、项目推广、创业培训、创业指导等多功能于一体的高端创意产业服务基地。',
		P5:'创意快装工场，以“科技兴国、创新强国”为使命，以“帮扶大众创业、助推万众创新”为宗旨，以“弘扬工匠精神，创新工匠产业”为目标。整合多方资源，联合行业专家，发行2亿文化创意产业基金，以“资源+专家+资金”三位一体，打造中国好项目超级平台，在将自有项目发展壮大的同时，依托强大资金、媒体、渠道、团队等资源优势，发现新项目，投资新项目，帮扶小项目，壮大好项目，通过产品研发、项目路演、股权投资、品牌策划、模式创新、渠道建设、市场运营等手段，为好项目提供全方位的品牌运营服务，让每个项目功能独特、应用广泛、走向市场，服务大众，取得可观的经济效益和品牌效益。丰硕的成绩，获得了社会各界的一致认可。本次集团公司全球中小企业股权交易中心成功挂牌，不仅是对创意工场的认可，更是对多年来集团公司始终坚持“实业兴国、创意强国”理念的一次肯定。展望未来，创意快装工场信心百倍，相信在社会各界的指导和支持下，有全体员工高度的使命感和责任感，借助资本的力量，产学研相结合，一定能为国家、为社会、为客户、为员工作出更大的贡献！',
		img1:'img/xianggang04.jpg', 
		img2:'img/xianggang08.jpg'
	},
	newsdetailersUl:[
			{newsdetailersImg:'img/icon01.png',newsdetailerszuo:'阅读：',newsdetailerstime:'50'},
			{newsdetailersImg:'img/icon03.png',newsdetailerszuo:'发布：',newsdetailerstime:'2017-10-25'},
	]
};
...
var ul7_1 = Vue.extend({
	template:'<ul><li v-for="newsdetailersx in newsdetailers.newsdetailersUl"><img v-bind:src="newsdetailersx.newsdetailersImg" />{{newsdetailersx.newsdetailerszuo}}<span>{{newsdetailersx.newsdetailerstime}}</span></li></ul>'
});
var p7_1 = Vue.extend({
...
var p7_4 = Vue.extend({
	template:'<p>{{newsdetailers.newsdetailersLi.P4}}</p>'
});
var p7_5 = Vue.extend({
	template:'<p>{{newsdetailers.newsdetailersLi.P5}}</p>'
});
...
var div7_1 = Vue.extend({
	template:'<div class="particulars_li"><child8></child8><child9></child9><child10></child10><child11></child11><child12></child12><child13></child13><child14></child14><child15></child15><child16></child16></div>',
	components: {
		'child8': h47_1,
    	'child9': ul7_1,
    	'child10': p7_1,
...
var span7_2 = Vue.extend({
	template:'<span>热烈祝贺创意快装工场在全球小企业股权交易中心挂牌</span>'
});
...
//	   		console.log(particulars_top.innerHTML);
	   		if(particulars_top.innerHTML == '第一条') {
	   			alert('第一条');
	   			return false;
	   		}else {
	   ...
	   particulars_bottom.onclick = function() {
	   	if(particulars_bottom.innerHTML == '最后一条') {
	   		alert('最后一条');
	   		return false;
	   	}else{
	   		window.location.href = 'news_details.html';
