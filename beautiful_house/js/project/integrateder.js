...
var integrateders = {
	...
	integratedersDao:'创艺养生墙',
	integratedersDaoy:'XQTK',
	integratedersLi: {
		H4:'创艺养生墙饰--功能创意装饰领导品牌',
...
var Img8_3 = Vue.extend({
	template:'<img v-bind:src="integrateders.integratedersLi.img2" />'
});
var div8_1 = Vue.extend({
	template:'<div class="particulars_li project_div"><child5></child5><child19></child19><child6></child6><child7></child7><child8></child8><child9></child9><child10></child10><child11></child11><child12></child12><child13></child13><child14></child14><child15></child15><child16></child16><child17></child17></div>',
	components: {
		'child5': h48_1,
		'child19': Img8_3,
    	'child6': p8_1,
